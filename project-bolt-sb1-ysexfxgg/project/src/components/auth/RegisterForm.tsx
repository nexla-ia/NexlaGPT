  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      <div className="mt-8 p-4 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-lg border border-cyan-500/20">
        <h3 className="text-sm font-medium text-white mb-2">🎉 Plano Inicial Incluído</h3>
        <ul className="text-xs text-gray-300 space-y-1">
          <li>• 1000 mensagens por mês</li>
          <li>• Respostas em até 15 segundos</li>
          <li>• Suporte por email</li>
          <li>• Apenas R$ 49/mês</li>
        </ul>
      </div>
    </div>
  );
